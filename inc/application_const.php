...
if(isset($_SERVER['HTTP_X_FORWARDED_PROTO']) == 'https'){
	...
	define('TEMPLATE_URL_WITHOUT_SLASH', 'https://'.SERVER_URL_WITHOUT_SLASH);
}else{
	define('TEMPLATE_URL', 'http://'.SERVER_URL);
	define('TEMPLATE_URL_WITHOUT_SLASH', 'http://'.SERVER_URL_WITHOUT_SLASH);
}
...
define('ADMIN_MAIL','edison.admin@onlineconsultant.jp');
...
//マップに表示されるアイコンに、進行方向をつけるか、半透明にするかの判定をする秒数
define('NOT_NEW_SECOND', 1800);
