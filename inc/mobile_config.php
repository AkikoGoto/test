...
$sid=SID;
	...
	if($carrier=='softbank'||$carrier=='au'){
		...
		$smarty->assign("css",'<LINK rel="stylesheet" href="'.TEMPLATE_URL.'templates/css/mobile.css" 
		...
		$smarty->assign("css",'<LINK rel="stylesheet" href="'.TEMPLATE_URL.'templates/css/smart_phone.css" 
			type="text/css">
		...
		$smarty->assign("css",'<LINK rel="stylesheet" href="'.TEMPLATE_URL.'templates/css/pc.css" 
