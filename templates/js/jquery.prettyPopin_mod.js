...
//					$('.prettyPopin a[rel=internal]').click(function(){
					...
					//"ページングのために、internalというクラスで内部リンクを生成　By　Goto
					...
					$('.prettyPopin form').bind('submit',function(){
						...
						$c.fadeOut(function(){
							...
							// Submit the form
							// submit時のメソッドは、元のFormのメソッドに合わせるように修正 by m.tanaka
							if($theForm.attr('method').toLowerCase() ==  'get') {
								$.get($theForm.attr('action'), $theForm.serialize(),function(responseText){
									// Replace the content
									$c.html(responseText);
